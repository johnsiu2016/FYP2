...
const commonNames = {
  ...
  "MDC_TTHOR_RESP_RATE": "RR TTHOR",
  "MDC_PULS_OXIM_PULS_RATE": "PR",
  "MDC_PULS_OXIM_SAT_O2": "SpO2",
  "MDC_CO2_RESP_RATE": "RR",
  "MDC_AWAY_CO2_ET": "etCO2",
  "MDC_PRESS_BLD_ART_ABP_NUMERIC": "ABP"
};
...
const flotNames = {
  ...
  "MDC_ECG_LEAD_I": "monitor-MDC_ECG_HEART_RATE",
  "MDC_ECG_LEAD_II": "monitor-MDC_ECG_HEART_RATE",
  "MDC_ECG_LEAD_III": "monitor-MDC_ECG_HEART_RATE",
...
const relatedNumeric = {
  ...
  "MDC_ECG_LEAD_I": [],
  "MDC_ECG_LEAD_II": [{code:"MDC_ECG_HEART_RATE",name:"MDC_ECG_HEART_RATE"}],
  "MDC_ECG_LEAD_III": [],
...
export function getRange(metric_id) {
  // Currently assumes units match
  return range[metric_id];
}

export function getPlotColor(metric_id) {
  return plotColors[metric_id] || "#FFFFFF";
}

export function getCommonName(metric_id) {
  return commonNames[metric_id] || metric_id;
}

export function getFlotName(metric_id) {
  return flotNames[metric_id] || "monitor";
}

export function getRelatedNumeric(metric_id) {
  return relatedNumeric[metric_id] || [];
}

export function getFillArea(metric_id) {
